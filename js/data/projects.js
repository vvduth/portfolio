...
export const projects = [
  ...
  },
  {
    ...
    description:
      "A full-featured real estate platform, allow users to browse, list, and manage properties.",
  ...
  },
  {
    ...
    title: "Matchyy",
    description:
      "Social dating app, users can like, upload pictures, live-talk, update profile with others.",
  ...
  },
  {
    ...
    title: "AI Summary",
    description:
      "A modern SAAS web application that lets you upload PDF files and receive concise, AI-generated summaries",
  ...
  },
  {
    ...
    title: "Get Yolk",
    description:
      "An AI-powered coach for combat athletes — functional strength, clean diets.",
    image: "./get-yolk.png",
    tags: [
      "Next.js",
      "Tailwind CSS",
  ...
  },
  {
    ...
    title: "RentApp",
    description:
      "A full-stack rental property management application. Closed because of AWS cost too much.",
  ...
  },
  {
    ...
    title: "Foodboot",
    description:
      "A comprehensive food delivery application. Closed because of AWS cost too much.",
    image: "./foodboot.png",
    tags: [
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    title: "Dukem Travel",
    description:
      "An AI-powered travel planning platform that creates personalized trip itineraries.",
  ...
  },
  {
    ...
    title: "Dukem stock",
    description:
      "Stock market tracking and analysis platform built with Next.js 15, featuring real-time market data, watchlists, AI personalized news",
